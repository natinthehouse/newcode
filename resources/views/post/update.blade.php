...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('posting') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/update{{ $post->id }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="judul" value="{{ $post->judul }}" required autocomplete="name" autofocus>
